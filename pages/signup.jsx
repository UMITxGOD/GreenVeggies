    ...
    <div>
      <div className="flex min-h-full items-center justify-center py-12 px-4 sm:px-6 lg:px-8">
        <div className="w-full max-w-md space-y-8">
          ...
          <form
            className="mt-8 space-y-6 text-green-400"
            action="#"
            method="POST"
          >
            ...
            <div className="-space-y-px rounded-md shadow-sm">
              ...
              <div>
                ...
                <input
                  ...
                  autocomplete="email"
                  required
                  className="relative block w-full appearance-none  border border-gray-300 px-3 py-2 text-gray-900 placeholder-gray-500 focus:z-10 focus:border-green-500 focus:outline-none focus:ring-green-500 sm:text-sm"
